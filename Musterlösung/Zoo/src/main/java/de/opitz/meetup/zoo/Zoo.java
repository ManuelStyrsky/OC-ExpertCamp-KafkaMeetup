...
import de.opitz.meetup.Animals.AnimalFactory;
...
public class Zoo {
    ...
    private String topic = "test"; //TODO initialize with your topic
    private String bootstrapServers = "127.0.0.1:9092"; //TODO initialize with your bootstrapServers (hint: the port is per default 9092)
    ...
    private void animalOutbreak() {
        ...
        Properties properties = readKafkaProperties();
        kafkaProducer = new KafkaProducer<String,String>(properties); //TODO create your kafka producer

        while (true) {
            Animal animal = new AnimalFactory().createRandomAnimal(); //TODO initialize with a concrete Animal (hint: you may use the Factory)
