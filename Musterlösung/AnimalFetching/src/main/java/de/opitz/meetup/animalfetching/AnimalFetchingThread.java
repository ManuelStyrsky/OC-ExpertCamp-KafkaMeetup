...
public class AnimalFetchingThread extends Thread {
    ...
    private String bootstrapServers = "127.0.0.1:9092"; //initialize with your bootstrap servers
    private String topic = "test2"; //initialize with your topic
    private String groupIDConfig = "toSQL"; //give your app an identifier
    private String tablename = "test"; //give your table name here
    ...
    private void initializeConsumer() {
        ...
        consumer.subscribe(Collections.singleton(topic)); //subscribe consumer to topic(s)
    ...
    private void handleRecord(ConsumerRecord<String, String> record) {
        ...
        try {
            ...
            try {
                ...
                LOGGER.info("wrote record to database");
            } catch (SQLException e) {
